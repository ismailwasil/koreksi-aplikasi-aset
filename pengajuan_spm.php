    ...
    <div id="dataLive">
        ...
        <section class="section">
                            ...
                            <div class="card-body px-1 py-1-1">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <h4 class="font-extrabold mb-0"><strong id="jml-verif-user"><?= $jumlahVerif ?></strong></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body px-1 py-1-1">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <h4 class="font-extrabold mb-0"><strong id="jml-proses-user"><?= $jumlahProses ?></strong></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body px-1 py-1-1">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <h4 class="font-extrabold mb-0"><strong id="jml-tolak-user"><?= $jumlahTolak ?></strong></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <?php if ($user['status_skpd'] != NULL): ?>
                    ...
                    <?php else: ?>
                            <script>
                                const idMasuk = '<?= $user['id'] ?>'; // ini variable yang akan mengirim id yang sedang log in ke js tombolKabur
                            </script>
                        <?php if ($user['id'] == 5) : ?>
                            ...
                            <div class="center-is">
                                ...
                                <div id="tombolpwd" class="d-none">
                                    <input type="password" placeholder="masukkan password" id="passwordPUPR"><button onclick="bukaModalAjukanSPM()">OK</button><button onclick="location.reload()">Cancel</button>
                                </div>
                                ...
                                <div class="card-content" id="isi_data_Baradha_E">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                                    ...
                                                    <tbody id="data">
                                                        <?php foreach ($spm_verified as $mspm) : ?>
                                                            <tr>
                                                                ...
                                                                <td class="text-center"><?= $mspm['total_spm'] == NULL ? "" : number_format($mspm['total_spm'], 2, ',', '.'); ?></td>
                                        ...
                                        <div class="tab-pane fade" id="proses" role="tabpanel" aria-labelledby="proses-tab">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover table-sm mb-0 super-small-table" id="tableprosesUser" style="width: 100%;">
                                                    <thead class="thead-ismail">
                                                        <tr>
                                                            <th class="text-center">NO</th>
                                                            <th class="text-center">TANGGAL</th>
                                                    ...
                                                    <tbody id="data">
                                                        ...
                                                        foreach ($spm_proses as $pspm) : ?>
                                                            <tr>
                                                                ...
                                                                <td class="text-center"><?= $pspm['total_spm'] == NULL ? "" : number_format($pspm['total_spm'], 2, ',', '.'); ?></td>
                                                                <td class="text-center">
                                        ...
                                        <div class="tab-pane fade" id="tolak" role="tabpanel" aria-labelledby="tolak-tab">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover mb-0 super-small-table" id="tabletolakUser" style="width: 100%;">
                                                    <thead class="thead-ismail">
                                                        <tr>
                                                            <th class="text-center">NO</th>
                                                            <th class="text-center">TANGGAL</th>
                                                    ...
                                                    <tbody id="data">
                                                        <?php foreach ($spm_tolak as $tspm) : ?>
                                                            <tr style="background-color: #f1e4e6fa;">
                                                                ...
                                                                <td class="text-center"><?= $tspm['total_spm'] == NULL ? "" : number_format($tspm['total_spm'], 2, ',', '.'); ?></td>
                                                                <td class="text-center">
                                                                                                    ...
                                                                                                    <div class="position-relative">
                                                                                                        <select class="form-select" id="jenis" name="jenis" required>
                                                                                                            <option disabled value="">--Pilih Jenis
                                                                                                                SPM--</option>
                                                                                                            <option <?= $tspm['jenis'] == "BELANJA MODAL SEMESTER I/II" ? "selected" : null ?> value="BELANJA MODAL SEMESTER I/II">
                                                                                                                BELANJA MODAL SEMESTER I/II</option>
                                                                                                            <option <?= $tspm['jenis'] == "BUKU PERSEDIAAN" ? "selected" : null ?> value="BUKU PERSEDIAAN">BUKU PERSEDIAAN
                                                                                                            <option <?= $tspm['jenis'] == "BUKAN BELANJA MODAL/PERSEDIAAN" ? "selected" : null ?> value="BUKAN BELANJA MODAL/PERSEDIAAN">BUKAN BELANJA MODAL/PERSEDIAAN
                                                                                                            </option>
                                                                                                        </select>
                                                                                                    </div>
                                                                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative">
                                                <select class="form-select" id="jenis" name="jenis" required>
                                                    ...
                                                    <option value="BELANJA MODAL" class="bg-light-warning">BELANJA MODAL</option>
                                                    <option value="BELANJA PERSEDIAAN" class="bg-light-success">BELANJA PERSEDIAAN</option>
                                                    <option value="BUKAN BELANJA MODAL/PERSEDIAAN" class="bg-light-danger">BUKAN BELANJA MODAL/PERSEDIAAN</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="total-spm">
                                                <h6><i class="fa fa-fw fa-money"></i> Jumlah SPP Diminta <span style="color: red;"><strong>*</strong></span> <small class="text-white">lihat di lembar SPM</small></h6>
                                            </label>
                                            <div class="position-relative">
                                                <input type="text" class="form-control" placeholder="Masukkan jumlah SPP Diminta" id="total-spm" name="total-spm" required>
