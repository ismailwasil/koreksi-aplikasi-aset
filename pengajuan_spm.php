                        ...
                        <?php if ($user['id_role'] == 4): ?>
                            <details>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="table-responsive">
                                            <h6>Tabel Hari Libur Nasional</h6>
                                            <button class="btn btn-sm" data-bs-toggle="modal"
                                                data-bs-target="#modalAddLibnas"><i class="fa fa-plus"></i></button>
                                            <table class="table table-bordered table-hover mb-0 super-small-table"
                                                style="width: 100%;">
                                                ...
                                                <tbody class="text-center">
                                                    ...
                                                    foreach ($dataHariLibur as $dtharlib):
                                                    ?>
                                                        <tr>
                                                            <td><?= formatTanggalIndo($dtharlib['tanggal_libnas']) ?></td>
                                                            <td><?= $dtharlib['ket_libnas'] ?></td>
                                                            <td>
                                                                <button class="btn btn-sm btn-libnas"
                                                                    data-id="<?= $dtharlib['id_libnas'] ?>"
                                                                    data-tgl_libnas="<?= $dtharlib['tanggal_libnas'] ?>"
                                                                    data-ket_libnas="<?= $dtharlib['ket_libnas'] ?>"
                                                                    data-bs-toggle="modal" data-bs-target="#modalViewLibnas">
                                                                    <i class="fa fa-pencil"></i>
                                                                </button>
                                                            </td>
                                                        </tr>
                                            ...
                                            <!-- Modal Add Libnas -->
                                            <div class="modal fade" id="modalAddLibnas" tabindex="-1">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">

                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="titleJK">Tambah Hari Libur Nasional
                                                            </h5>
                                                            <button type="button" class="btn-close"
                                                                data-bs-dismiss="modal"></button>
                                                        </div>

                                                        <form method="post" action="<?= base_url('developer/addLibnas') ?>">
                                                            <div class="modal-body">

                                                                <div class="mb-2">
                                                                    <label class="text-white"
                                                                        for="tanggal_libnas">Tanggal</label>
                                                                    <input type="date" id="tanggal_libnas"
                                                                        name="tanggal_libnas" class="form-control">
                                                                </div>

                                                                <div class="mb-2">
                                                                    <label class="text-white"
                                                                        for="ket_libnas">Keterangan</label>
                                                                    <input type="text" id="ket_libnas" name="ket_libnas"
                                                                        class="form-control">
                                                                </div>
                                                            </div>
                                            ...
                                            <!-- /Modal Add Libnas -->
                                            <!-- Modal View Libnas -->
                                            <div class="modal fade" id="modalViewLibnas" tabindex="-1">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">

                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="titleLibnas">Edit Data Libnas</h5>
                                                            <button type="button" class="btn-close"
                                                                data-bs-dismiss="modal"></button>
                                                        </div>

                                                        <form id="formEdit" method="post"
                                                            action="<?= base_url('developer/editLibnas') ?>">
                                                            <div class="modal-body">
                                                                <input type="hidden" id="id_libnas" name="id_libnas">

                                                                <div class="mb-2">
                                                                    <label class="text-white"
                                                                        for="tanggal_libnas_view">Tanggal</label>
                                                                    <input type="date" id="tanggal_libnas_view"
                                                                        name="tanggal_libnas_view" class="form-control">
                                                                </div>

                                                                <div class="mb-2">
                                                                    <label class="text-white"
                                                                        for="ket_libnas_view">Keterangan</label>
                                                                    <input type="text" id="ket_libnas_view"
                                                                        name="ket_libnas_view" class="form-control">
                                                                </div>
                                                            </div>

                                                            <div class="modal-footer">
                                                                <button type="button" id="deleteLibnas"
                                            ...
                                            <script>
                                                document.querySelectorAll('.btn-libnas').forEach(button => {
                                                    button.addEventListener('click', function() {

                                                        // ambil data dari tombol
                                                        let id = this.dataset.id;
                                                        let tanggal_libnas = this.dataset.tgl_libnas;
                                                        let ket_libnas = this.dataset.ket_libnas;

                                                        // masukkan ke form modal
                                                        document.getElementById('titleLibnas').innerHTML =
                                                            "Edit Data " + tanggal_libnas;
                                                        document.getElementById('id_libnas').value = id;
                                                        document.getElementById('tanggal_libnas_view').value =
                                                            tanggal_libnas;
                                                        document.getElementById('ket_libnas_view').value =
                                                            ket_libnas;

                                                        // atur tombol delete
                                                        const btnDelete = document.getElementById(
                                                            'deleteLibnas');
                                                        btnDelete.innerHTML = "Delete " + id;
                                                        btnDelete.addEventListener('click', function() {
                                                            if (confirm(
                                                                    'Yakin ingin menghapus data ini?'
                                                                )) {
                                                                window.location.href =
                                                                    "<?= base_url('developer/deleteLibnas/') ?>" +
                                                                    id;
                                                            }
                                                        })
                                                    });
